  ...
  render() {
    ...
    return (
      <div style={{width: '100%'}}>
        ...
        />
        <RaisedButton fullWidth primary disabled={this.state.hasChanged !== true} label="Submit Changes" />
        <div style={{ height: '70%', overflow: 'auto', boxShadow: '0px 0px 1px 0.1px black inset'}}>
        <ItemWrapper style={itemWrapperStyle}>
          Topic <TextField style={textfieldStyle} value={this.state.topic} onChange={(_,__, topic) => { this.setState({ topic, hasChanged: true }); }} />
        </ItemWrapper>
        <ItemWrapper style={itemWrapperStyle}>
          Value <TextField style={textfieldStyle} value={this.state.value} onChange={(_,__, value) => { this.setState({ value, hasChanged: true }); }} />
        </ItemWrapper>
        <ItemWrapper style={itemWrapperStyle}>
          Strategy
        ...
        <ItemWrapper style={itemWrapperStyle}>
          Rate <TextField style={textfieldStyle} value={this.state.rate} onChange={(_,__, rate) => { this.setState({ rate, hasChanged: true }); }} />
        </ItemWrapper>
        <ItemWrapper style={itemWrapperStyle}>
